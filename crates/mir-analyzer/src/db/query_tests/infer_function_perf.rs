...
//!
//! Run with:
//!   cargo test -p mir-analyzer --lib --release infer_function_perf -- --nocapture --ignored
//!
...
use crate::db::{collect_file_definitions, infer_function, parse_file, MirDatabase};
