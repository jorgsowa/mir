...
use core::{
    ...
    extract_nullsafe_prop_access, extract_static_prop_access_parts, extract_var_name,
    narrow_count_or_strlen_equality, peel_parens, promote_assignment_effects, same_literal,
    set_narrowed, ScalarArgTarget, UnionNarrowExt,
};
